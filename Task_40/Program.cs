/*
40. Напишите программу,которая принимает три числа и определяет, может ли существовать треугольник 
с сторонами такой длины (т.е. сумма двух сторон д.б. больше третье стороны)
*/
